...
* .getPresence()
* .then(function(presence){
*    // abc123 and pqr123 are user uid.
*    var newPresence = presence.setWhiteList(['abc123','pqr123']); 
* });
* @return {Presence}
*/
...
*    //Accepts first 2 users request
*    var newPresence = presence.acceptRequests(requests.slice(0,2)); 
